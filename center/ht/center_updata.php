...
$id = $get['id'];
$db=new mysql();
$db->query("select * from all_center where id = '{$id}'");
$row = $db->fetch_assoc();
?>
<!DOCTYPE html>
<html>
                        ...
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <form method="post" class="form-horizontal" action="act.php" enctype="multipart/form-data">
                                	...
                                	<input type="hidden" name="witch" value="centerupdata" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group col-sm-5">
                                            <input type="text" class="form-control" name="tutor_name1" value="<?php echo $row["tutor_name1"];?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group col-sm-10">
                                            ...
                                            <input type="hidden" name="img_name1" value="<?php echo $row["tutor_img1"];?>" />
                                            <img class="img" src="./upload/<?php echo $row["tutor_img1"];?>" width="150">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group col-sm-5">
                                            <input type="text" class="form-control" name="names1" value="<?php echo $row["names1"];?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group col-sm-10">
                                            ...
                                            <input type="hidden" name="img_name2" value="<?php echo $row['head_img1']; ?>"/>
                                            <img class="img1" src="./upload/<?php echo $row["head_img1"];?>" width="150">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group col-sm-5">
                                            <input type="text" class="form-control" name="url1" value="<?php echo $row["url_1"];?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group col-sm-5">
                                            <input type="text" class="form-control" name="tutor_name2" value="<?php echo $row["tutor_name2"];?>">
                                        </div>
                                    </div>

                                    <div class="hr-line-dashed"></div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">学龄组导师的图片</label>

                                        <div class="input-group col-sm-10">
                                            <input type="file" name="tutor_img2" class="tutor_img2">
                                            <input type="hidden" name="img_name3" value="<?php echo $row["tutor_img2"];?>" />
                                            <img class="img3" src="./upload/<?php echo $row["tutor_img2"];?>" width="150">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group col-sm-5">
                                            <input type="text" class="form-control" name="names2" value="<?php echo $row["names2"];?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group col-sm-10">
                                            ...
                                            <input type="hidden" name="img_name4" value="<?php echo $row['head_img2']; ?>"/>
                                            <img class="img2" src="./upload/<?php echo $row["head_img2"];?>" width="150">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group col-sm-5">
                                            <input type="text" class="form-control" name="url2" value="<?php echo $row["url_2"];?>">
                                        </div>
                                    </div>
