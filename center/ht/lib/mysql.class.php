...
class mysql{
	...
	/*构造函数*/
	public function __construct($db_host = "127.0.0.1",$db_user = "root",$db_pwd = "root",$db_database = "app_champion",$conn = "",$coding = "UTF8"){

	//	public function __construct($db_host = "rdsemyjqvemyjqv.mysql.rds.aliyuncs.com",$db_user = "youlikang",$db_pwd = "youlikang123",$db_database = "app_img",$conn = "",$coding = "UTF8"){
	...
	*/
	...
	public function select($table,$columnName,$condition)
	{
		...
		$this->query("SELECT $columnName FROM $table WHERE $condition");

	}

	public function selectRows($table,$columnName,$condition)
	{
		if($columnName==""){
			$columnName="*";
		}

		$this->query("SELECT $columnName FROM $table WHERE $condition limit 1");
